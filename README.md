...
- 재현 가능한 5,000행 합성 검수 benchmark에서 로드 약 0.99초, 검색 중앙 약 1.19초, 다음 항목 약 37ms, 실제 저장 중앙 약 0.55초를 기록했습니다. RMK XLSX 5,000행 생성은 약 7.29초, 갱신 중앙은 약 8.64초였습니다. 실행 명령은 `docs/QUALITY_GATES.md`에 있습니다.
...
4. 항목별로 원문, 번역 후보, 기존 번역, 용어, 메모, 문제 경고를 확인합니다. 용어 탭은 동일 원문의 안전한 로컬 번역 메모리를 출처와 함께 제안하지만 번역 칸을 자동으로 바꾸지 않습니다.
